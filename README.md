# OpenSMTPD stack for Wodby

Deploy OpenSMTPD on Kubernetes with Wodby. This repository contains the stack
manifests used by the public OpenSMTPD stack in the Wodby catalog.

- [OpenSMTPD stack in the Wodby catalog](https://wodby.com/stacks/opensmtpd)
